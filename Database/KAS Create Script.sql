...
create table PV(
                ...
                pv_delivery_id int not null,                                                 -- Foreign key to delivery / Where the product went
...
alter table PV
add constraint PV_fk_delivery
foreign key (pv_delivery_id) references delivery(delivery_id)
ON DELETE NO ACTION ON UPDATE NO ACTION;